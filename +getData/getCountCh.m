function c = getCountCh(ll, clnm, invalidity, binLimDt)
    ...
    lblSetInval = getEegInvalidLblSet(ll, invalidity); % Label set containing the labels of invalidating (contaminating) phenomena (e.g. artifacts or seizures)
    ...
    for kch = 1 : numch
        ...
        lblSetInvalCh = lblSetInval(lblSetInval.Channel == kch, :);
